...
public class MockUtility {
	...
	public Event getEvent() {
		...
		return new Event(1, "Bonfire", "", "People standing by a fire", "2019-01-29T08:00",
				getAddress(), 21, 1, getEventCategory(), getUser());  
	}
	...
	public List<Event> getEventList() {
		...
		list.add(new Event(1, "Bonfire", "", "People standing by a fire", "2019-02-29T08:00",
				addressList.get(0), 21, 1, getEventCategory(), getUser()));  
		list.add(new Event(2, "Fishing", "", "People standing by a fire", "2019-02-02T09:10",
				addressList.get(1), 22, 0, getEventCategory(), getUser()));  
		list.add(new Event(3, "Concert", "", "People standing by a fire", "2019-03-13T12:09",
				addressList.get(2), 100, 1, getEventCategory(), getUser()));  
		list.add(new Event(4, "Volunteer", "", "People standing by a fire", "2019-02-11T08:11",
				addressList.get(3), 200, 0, getEventCategory(), getUser()));  
	...
	public Address getAddress() {
		return new Address(1, "1600 Pennsylvannia Avenue", "", "Washington D.C.", "Virginia",
				12345); 
	}
