...
VALUES (1,'Grandma@art.com','Grandmother','Moses','ArtForAll',NULL,1234,2,1);
INSERT INTO KROWD_USER (id,email,firstname,lastname,username,picture,reputation,role_id,account_status) 
VALUES (2,'shepherd@lamb.com','Bo','Peep','BoPeep',NULL,87,1,0);
INSERT INTO KROWD_USER (id,email,firstname,lastname,username,picture,reputation,role_id,account_status) 
VALUES (3,'DevilCurseTheKing@USA.gov','John Paul','Jones','Madman',NULL,12,2,1);
INSERT INTO KROWD_USER (id,email,firstname,lastname,username,picture,reputation,role_id,account_status) 
VALUES (4,'I''llDieWithThisHammerInMyHand@CCC.gov','John','Henry','HammerMan',NULL,870,1,1);
INSERT INTO KROWD_USER (id,email,firstname,lastname,username,picture,reputation,role_id,account_status) 
VALUES (5,'JaneDoe@generic.com','Jane','Doe','Generic',NULL,34,1,1);
INSERT INTO KROWD_USER (id,email,firstname,lastname,username,picture,reputation,role_id,account_status) 
VALUES (6,'Computer@NASA.gov','Katherine','Johnson','MathWiz',NULL,8,1,1);
INSERT INTO KROWD_USER (id,email,firstname,lastname,username,picture,reputation,role_id,account_status) 
...
VALUES (1,'First Meet Up!','January 27th, 2019',1,0,7,1,'Krowd Tampa has it''s first meeting today! I''d love to see you there.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (2,'Arts and Crafts with Grandma','January 27th, 2019',1,0,1,1,'I''d love to share my knowledge of art with all my friends.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (3,'Learn to Bake.','January 28th, 2019',1,0,2,1,'For those of you who''d like to learn how to bake, my home will be open. I''ll have all the ingredients so don''t worry.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (4,'Toy Drive','January 29th, 2019',8,0,6,1,'St Jude''s Children''s Hospital would love to have some donations of toys for the upcoming season. Any help is appreciated.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
...
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (6,'Swamp Orienteering','February 9th, 2019',3,0,4,2,'Want to learn how to find your way out of the swamp? I can teach you how.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (7,'Trees of Tampa','February 16th, 2019',4,0,4,2,'The flora of Tampa are quite diverse. I''ll show you what''s what.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (8,'Sailor''s Serenade','February 2nd, 2019',5,0,3,3,'Come to the riverfront to sing sea shanties long into the night.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (9,'Spoils of the Sea','February 9th, 2019',6,0,2,3,'I''ll be cooking up all the sea has to offer, BYOB.',null);
INSERT INTO EVENT (id,name,date,address_id,flag,event_category_id,user_id,description,picture) 
VALUES (10,'Let''s clean up Tampa','February 10th, 2019',7,0,6,4,'Tampa could use some cleaning. Let''s pick up as much litter as possible.',null);
